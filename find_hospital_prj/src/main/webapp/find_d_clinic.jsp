...
<body>
	<div id="wrap">
        ...
        <section>
            <div class="box">
				...
				<span>치과 검색 : </span><input id="search" placeholder="치과 이름을 입력 후 enter" size="20"><br>
				<div id="find">
	...
	function search_hosp(){
	    ...
	    queryParams += '&' + encodeURIComponent('instit_kind') + '=' + encodeURIComponent('치과의원'); /**/
