...
<body>
        ...
        <section>
            <div class="box">
                ...
                <select>
                	...
                	<option>한방부인과</option>
                	<option>한방소아과</option>
                	<option>한방신경정신과</option>
                	<option>한방안이비인후피부과</option>
                	<option>한방응급과</option>
                	<option>한방재활의학과</option>
                </select>
				<span>한의원 검색 : </span><input id="search" placeholder="한의원 이름을 입력 후 enter" size="25"><br>
				<div id="find">
	...
	function search_hosp(){
	    ...
	    queryParams += '&' + encodeURIComponent('numOfRows') + '=' + encodeURIComponent('1500'); /**/
	    queryParams += '&' + encodeURIComponent('resultType') + '=' + encodeURIComponent('json'); /**/
	    queryParams += '&' + encodeURIComponent('instit_kind') + '=' + encodeURIComponent('한의원'); /**/
