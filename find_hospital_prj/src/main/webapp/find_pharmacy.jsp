...
<body>
	<div id="wrap">
        ...
        <section>
            <div class="box">
                <div id="title1">약국 찾기</div>
                <hr>
                <br>
				<span>약국 검색 : </span><input id="search" placeholder="약국 이름을 입력 후 enter" size="20"><br>
				<div id="find">
	...
	function search_hosp(){
	    ...
	    queryParams += '&' + encodeURIComponent('instit_kind') + '=' + encodeURIComponent('약국'); /**/
