...
<body>
	<div id="wrap">
        ...
        <section>
            <div class="box">
				...
				<span>한방병원 검색 : </span><input id="search" placeholder="한방병원 이름을 입력 후 enter" size="25"><br>
				<div id="find">
	...
	function search_hosp(){
	    ...
	    queryParams += '&' + encodeURIComponent('instit_kind') + '=' + encodeURIComponent('한방병원'); /**/
